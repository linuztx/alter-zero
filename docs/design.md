...
- **`/model` picker** (`docs/llm.md`). An **inline** picker (it replaces the
  ...
  type-to-search, and `Enter` rebuilds the backend for the chosen model and
  updates the footer. Rejected mid-turn like `/resume`.
