...
clip_first_pane="$(wait_pane 20.1 "$S108" -S -60 -- -F "Done for")" # the shortcut's turn → "Done for", no key pressed
...
expect_has "$clip_first_pane" -F "Done for" "the command-line prompt's turn never settled"
